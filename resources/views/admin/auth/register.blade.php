        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <form class="md-float-material form-material" action="{{url('admin/auth/register')}}" method="post">
                      {{csrf_field()}}
                        ...
                        <div class="auth-box card">
                            <div class="card-block">
                                <div class="row m-b-20">
                                    <div class="col-md-12">
                                        <h3 class="text-center txt-primary">Ouvrir Un Compte</h3>
                                    </div>
                                </div>
                                <div class="row m-b-20">
                                    <div class="col-md-12">
                                ...
                                <div class="form-group form-primary">
                                    <input type="text" name="adresse" class="form-control" required="" value="{{ old('adresse') }}">
                                    <span class="form-bar"></span>
                                ...
                                <div class="form-group form-primary">
                                    <input type="text" name="email" class="form-control" required="" value="{{ $errors->first('email') }}">
                                    <span class="form-bar"></span>
                                ...
                                <div class="row m-t-30">
                                    <div class="col-md-12">
                                        <button type="submit" class="btn btn-primary btn-md btn-block waves-effect text-center m-b-20">SOUMETTRE</button>
                                    </div>
                                </div>
                                <p class="text-inverse text-left text-center">Vous avez déja un compte? <a href="{{url('admin/auth/login')}}"><b> s'authentifier</b></a></p>
                            </div>
                        </div>
                    </form>
                        <!-- end of form -->
