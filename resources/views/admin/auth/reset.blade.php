...
<head>
    <title>Epay | Réinitialiser le mot de passe</title>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <form class="md-float-material form-material" action="{{url('admin/auth/reset')}}" method="post">
                      {{csrf_field()}}
                        <div class="text-center">
                            <img src="{{ asset('adminPublic/assets/images/logo.png')}}" alt="logo.png">
                        </div>
                        <div class="auth-box card">
                            <div class="card-block">
                                <div class="row m-b-20">
                                    <div class="col-md-12">
                                        <h3 class="text-left">Récupérez votre mot de passe </h3>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <button type="submit" class="btn btn-primary btn-md btn-block waves-effect text-center m-b-20">Réinitialiser le mot de passe</button>
                                    </div>
                                </div>
                                <p class="f-w-600 text-right"> <a href="{{url('admin/auth/login')}}">Retour à la connexion.</a></p>
                            </div>
                        </div>
                    </form>
...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/auth-reset-password.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 18 Jul 2020 11:50:20 GMT -->
</html>
